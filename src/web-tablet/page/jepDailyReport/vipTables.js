              ...
              <tbody>
                {
                    props.data.map(item => (
                        ...
                        <td style={{width: '20%', textAlign: 'right'}}>{numeral(item.sub_total_amount).format('0,0')}.-</td>
                        <td style={{width: '38%'}}>{item.remark || item.table_number === 'Mixer' ? 'Mixer' : 'VIP: ' + item.table_number} </td>
